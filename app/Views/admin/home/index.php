      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?=$laporan['ipa']?>/<?=$laporan['ips']?></h3>
                <p>Pendaftar IPA/IPS</p>
              </div>
              <div class="icon">
        ...
        <div class="row">
          <div class="col-6">
            <div class="card">
              <div class="card-body">
                <button class="btn btn-success tambahModal mb-3" title="Tambah Angkatan"><i class="fa fa-plus"></i> Angkatan</button>
                <table id="datatable" class="table table-bordered table-hover table-angkatan">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a onclick="return confirm('Hapus data angkatan ini?\nTindakan ini tidak dapat diurungkan.')" href="<?=site_url('admin/angkatan/hapus/' . $v['id_angkatan'])?>" class="btn btn-sm btn-danger" title="Hapus data"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php  } ?>
                  </tbody>

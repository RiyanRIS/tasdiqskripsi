...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2023 at 11:40 AM
...
INSERT INTO `tbl_dt_pribadi` (`id`, `nama`, `tmpt_lahir`, `tgl_lahir`, `jenis_kelamin`, `alamat`, `asl_sekolah`, `no_tlpn`, `email`, `id_angkatan`, `jurusan`, `username`, `password`, `deleted_at`) VALUES
(2, 'tes123', 'tempat', '1222-12-12', 'Laki-laki', 'DUSUN KLIWONAN RT 004 RW 003', 'SMPIT LADIA GALASKA', '0000', 'aa@a.a', 3, 'IPS', '123', '$2y$10$NkK/ZTzo.ixllkIShYBqSuWaPWFhvPnICrYUnAMMy4Q.cnBzilHX6', NULL);
...
INSERT INTO `tbl_nilai` (`id_nilai`, `id_dt_pribadi`, `un_mat`, `un_bi`, `un_ipa`, `un_bing`, `nilai_ps`, `nilai_pa`, `nilai_wawancara`, `rata`, `berkas`) VALUES
(2, 2, 15, 22, 21, 22, 21, 22, 20, 20, '[]');
